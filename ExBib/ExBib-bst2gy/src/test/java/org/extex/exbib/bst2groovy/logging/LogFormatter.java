...
package org.extex.exbib.bst2groovy.logging;
...
/**
 * This class provides a means to format the log entries. This implementation
...
public class LogFormatter extends Formatter {
    ...
    /**
     * The field <tt>col</tt> contains the current column for the next output
     * character.
     */
    private int col;
     ...
     * @return the message
     */
    private CharSequence breakLine(StringBuilder out, CharSequence msg) {
