...
/**
 * This class implements the analyzer for the <code>num.names$</code> built-in.
 * 
 * @author <a href="mailto:gene@gerd-neugebauer.de">Gerd Neugebauer</a>
 * @version $Revision$
 */
public class NumNamesCompiler implements Compiler {

    /**
     * This inner class is the expression for the num.names$ built-in in the
     * target program.
     */
