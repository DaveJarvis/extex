 ...
 * If any of the types is incorrect, it complains and pushes the null string
 * .</dd>
 * </dl>
 *
 * <dl>
...
public class FormatName extends AbstractCode implements Serializable {
  ...
  private class Format extends ArrayList<FormatItem> {
     ...
     *                        ExBibSyntaxException in case that the
     *                        syntax is not correct<br>
     *                        ExBibImpossibleException this case should never
     *                        happen
     */
  ...
  private class FormatJJ extends FormatItem {
     ...
     */
    @Override
    public boolean format( StringBuilder buffer, Name name,
                           Locator locator ) {
  ...
  protected boolean fmtFull( StringBuilder buffer, List<String> list,
                             String mid, String midDefault, String pre,
                             String post,
                             int lineLength ) {
