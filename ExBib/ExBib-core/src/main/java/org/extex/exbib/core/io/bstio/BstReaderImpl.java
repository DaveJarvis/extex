...
import org.extex.exbib.core.bst.command.impl.*;
...
public class BstReaderImpl extends AbstractFileReader
   ...
   *                        ExBibUnexpectedEofException in case that the
   *                        end of file has been
   *                        reached before the expected character could be
   *                        read<br>
   *                        ExBibImpossibleException in case of an internal
   *                        error which
   *                        should not happen
   */
    ...
    addInstruction( "function", new Instruction() {
      ...
      public void parse( BstProcessor processor, Locator locator )
        ...
        processor.addFunction( fname,
                               new MacroCode( fname, body.getTokenList() ),
                               locator );
   ...
   * @throws ConfigurationException    in case that the reading apparatus
   * detects
   *                                   a misconfiguration
   ...
   *                                ExBibBstNotFoundException in case that
   *                                the requested bst could
   *                                not be opened for reading
   ...
   * @throws ExBibException in case of an error, especially<br>
   *                        ExBibEofException in case that the end of file
   *                        has been reached
   *                        before the block was complete<br>
   *                        ExBibSyntaxException in case of an syntax
   *                        error<br>
   *                        ExBibImpossibleException in case of an internal
   *                        error which
   *                        should not happen
   ...
   * successfully
   * @throws ExBibException in case of an error, especially<br>
   *                        ExBibEofException in case of an unexpected end of
   *                        file<br>
   *                        ExBibSyntaxException in case of an syntax error<br>
   *                        ExBibImpossibleException in case something
   *                        impossible happens
   */
