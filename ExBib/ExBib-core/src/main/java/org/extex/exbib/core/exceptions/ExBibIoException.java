...
public class ExBibIoException extends ExBibException {
     ...
     */
    public ExBibIoException(String message) {
     ...
     */
    public ExBibIoException(String message, Locator locator) {
     ...
     */
    public ExBibIoException(String message, Throwable cause) {
    ...
    public String getMessage() {
        ...
        return Messages.format("ExBibIoException.Message")
