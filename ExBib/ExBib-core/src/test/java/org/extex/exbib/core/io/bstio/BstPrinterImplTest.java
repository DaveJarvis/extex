...
public class BstPrinterImplTest {
  ...
  private static final String RESULT_1 =
      "ENTRY {\n"
          ...
          + "        { format.article.crossref output.nonnull format.pages " +
          "output    }\n"
          + "        if$\n"
          + "    new.block note\n"
          + "    output fin.entry}\n"
          ...
          + "    missing$\n"
          + "    { format.bvolume output new.block format.number.series " +
          "output new.sentence publisher\n"
          + "        \"publisher\" output.check address\n"
          + "        output    }\n"
          + "        { new.block format.book.crossref output.nonnull    }\n"
          + "        if$\n"
          + "    format.edition output format.date \"year\" output.check new" +
          ".block note\n"
          + "    output fin.entry}\n"
          + "\n"
          + "FUNCTION { booklet }{\n"
          + "    output.bibitem format.authors output new.block format.title " +
          "\"title\" output.check howpublished\n"
          + "    address\n"
          ...
          + "\"chapter and pages\" output.check new.block format.number" +
          ".series output new.sentence publisher\n"
          + "        \"publisher\" output.check address\n"
          + "        output    }\n"
          ...
          + "        \"publisher\" output.check address\n"
          + "        output format.edition output format.date \"year\" output" +
          ".check    }\n"
          + "        { format.incoll.inproc.crossref output.nonnull format" +
          ".chapter.pages output    }\n"
          + "        if$\n"
          + "    new.block note\n"
          + "    output fin.entry}\n"
          + "\n"
          ...
          + "    missing$\n"
          + "    { format.in.ed.booktitle \"booktitle\" output.check "
          + "format.bvolume output format.number.series output format.pages " +
          "output address\n"
          + "        empty$\n"
          + "        { organization\n"
          + "            publisher\n"
          ...
          + "            output format.date \"year\" output.check        }\n"
          + "            { address\n"
          + "            output.nonnull format.date \"year\" output.check new" +
          ...
          + "    't :=\n"
          + "    \"A \" #2 \"An \" #3 \"The \" #4 t chop.word chop.word chop" +
          ".word sortify #1 global.max$\n"
          + "    substring$\n"
          + "    }\n"
          + "\n"
          + "FUNCTION { sortify }{\n"
          ...
          + "FUNCTION { techreport }{\n"
          + "    output.bibitem format.authors \"author\" output.check "
          + "new.block format.title \"title\" output.check new.block format" +
          ".tr.number output.nonnull institution\n"
          ...
          + "MACRO { ieeetcad }{ \"IEEE Transactions on Computer-Aided Design" +
          ...
          + "MACRO { toois }{ \"ACM Transactions on Office Information " +
          "Systems\" }\n"
          + "MACRO { toplas }{ \"ACM Transactions on Programming Languages " +
          "and Systems\" }\n"
          + "\n"
          + "READ\n"
          + "ITERATE { presort }\n"
