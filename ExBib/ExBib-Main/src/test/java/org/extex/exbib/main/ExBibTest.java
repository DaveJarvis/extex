...
public class ExBibTest extends BibTester {
  ...
  private static final String USAGE =
      "Usage: exbib <options> file\n"
          ...
          " one.\n"
          + "\t--m[in-crossrefs] | --min.[crossrefs] | --min_[crossrefs] | -M" +
          " <n>\n"
  ...
  /**
   * Test that a missing bst in the aux file can be specified on the command 
   * line
   *
   * @throws Exception in case of an error
   */
  ...
  public void testAux13() throws Exception {
    ...
    runTest(
        ...
        BANNER
            ...
            + "I found no \\citation commands for bbl while reading " +
            "test.aux\n"
            + "(There were 2 errors)\n",
        "test.aux" );
  }
  ...
  public void testAux15() throws Exception {
    ...
    runTest(
        ...
        Check.EQ,
        BANNER
            + "I found no \\bibdata commands for bbl while reading " +
            "test.aux\n"
            + "(There was 1 error)\n",
        "test.aux" );
  }
  ...
  public void testConfig4() throws Exception {
    ...
    runFailure(
        BANNER
            ...
            + "Configuration syntax error XML document structures " +
            "must start and end within\n"
    ...
    ExBibMain exbib =
        runTest(
            ...
            "\\citation{Meone:Title}\n"
                + "\\bibdata{src/test/resources/bibtex/empty/none" +
                "}\n"
                + "\\bibstyle{src/test/resources/bibtex/empty" +
                "/empty_2}\n",
  ...
  /**
   * Test that the command line option {@code --language} can be used to set 
   * the language
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test that the command line option {@code -Dlanguage=} can be used to set
   * the language
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test that the command line option {@code --load} does not work with an 
   * empty argument
   *
   * @throws Exception in case of an error
   */
    ...
    try {
      AbstractMain exbib =
          runTest(
              ...
              Check.EQ,
              BANNER
                  + "I found no style file while reading test" +
                  ".aux\n"
                  + "I found no \\bibdata commands while " +
                  "reading test.aux\n"
                  + "I found no \\citation commands while reading test.aux\n"
                  + "(There were 3 errors)\n", "test.aux",
              "--log", log.toString() );
  ...
  /**
   * Test that the command line option {@code --min_crossrefs} needs an 
   * argument
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test that the command line option {@code --min.crossrefs} needs an 
   * argument
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test that the command line option {@code --min.crossrefs} stores its 
   * numeric argument
   *
   * @throws Exception in case of an error
   */
  ...
  public void testMinCrossrefsErr1() throws Exception {
    ...
    runTest( "test",
             ...
             Check.EQ,
             BANNER
                 + "The option `min.crossref' must be numeric instead of " +
                 "`xyz'.\n"
                 + "Warning: empty author in whole-journal\n"
                 + "Warning: empty title in whole-journal\n",
             "test.aux" );
    ...
    ExBibMain exbib =
        runTest(
            ...
            "\\citation[xxx]{*}\n"
                ...
                + "\\bibstyle[xxx]{src/test/resources/bibtex/base" +
                "/plain}\n",
            CLI.EXIT_OK, Check.EQ, BANNER
                + "Warning: empty author in whole-journal\n"
                + "Warning: empty title in whole-journal\n",
  ...
  /**
   * Test that the command line option {@code --outfile} takes an empty 
   * argument to discard the output
   *
   * @throws Exception in case of an error
   */
  @Test
  ...
  public void testProgName11() throws Exception {
    ...
    AbstractMain exbib =
        runTest(
            ...
            "\\citation{*}\n"
                + "\\bibdata{src/test/resources/bibtex/base/xampl.bib}\n"
                + "\\bibstyle{src/test/resources/bibtex/base" +
                "/plain}\n",
  ...
  /**
   * Test that the command line option {@code --progname} can be used to 
