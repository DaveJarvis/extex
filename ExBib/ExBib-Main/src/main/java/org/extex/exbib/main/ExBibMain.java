 ...
 * <dd>Use the specified sorter, e.g. {@code locale:de} or {@code csf:ascii.}
 * </dd>
...
public class ExBibMain extends AbstractMain {
  ...
  protected void declareOptions() {
    ...
    option( null,
            "--strict",
            new NoArgPropertyOption( "opt.strict",
                                     ExBib.PROP_CONFIG,
                                     CONFIGURATION_0_99,
                                     properties ),
            "--bibtex" );
    ...
    option( "-o",
            "--output",
            new StringPropertyOption( "opt.output",
                                      ExBib.PROP_OUTFILE,
                                      properties ),
            "--outfile" );
    option(
