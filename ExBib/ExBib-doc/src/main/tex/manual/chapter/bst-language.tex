...
This function takes a string valued argument and removes certain characters.
...
text characters. A \TeX\ control sequence counts as one charater -- no
matter how long the name may be.
...
braces are contained in the result of theis function.
