 ...
 * @version $Revision$
 */
public class PreambleInfo implements Info {

    /**
     * The field <tt>NEWLINE</tt> contains the ...
     */
    private static final GCode PREAMBLE = new GCode() {
        ...
        public void print(Writer writer, String prefix) throws IOException {
            ...
            writer.write("\n");
            writer.write(prefix);
            writer.write("bstDB.getPreamble()");
        }
    };
