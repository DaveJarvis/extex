 ...
 * @version $Revision$
 */
public class GetLocalStringInfo implements Info {

    /**
     * TODO gene: missing JavaDoc.
     * 
     */
    private class GetLocalString implements GCode {

        /**
         * The field <tt>entry</tt> contains the ...
         */
     ...
     * @param name
     */
    public GetLocalStringInfo(String name) {
    ...
    public void evaluate(EntryRefernce entryRefernce, OpenEndedStack stack,
        ...
        stack.push(new GetLocalString(entryRefernce.getName()));
    }
