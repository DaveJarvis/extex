...
/**
 * This class implements the analyzer for the substring$ builtin.
 * 
...
public class SubstringCompiler implements Compiler {
    ...
    /**
     * This inner class is the expression for the substring$ builtin in the
     * target program.
     */
    private static class Substring extends GenericCode {
        ...
        private Substring(GCode a, GCode b, GCode c) {
            ...
            super(ReturnType.STRING, "substring", a, b, c);
        }
    }
