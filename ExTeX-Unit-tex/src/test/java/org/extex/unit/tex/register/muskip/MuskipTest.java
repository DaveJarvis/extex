...
public class MuskipTest extends AbstractMuskipRegisterTester {
    ...
    public void test11() throws Exception {
        ...
        assertSuccess(// --- input code ---
            "\\count0=2 " + "\\muskip0=\\count0mu" + "\\the\\muskip0\\end",
            // --- log message ---
            "2.0mu" + TERM);
    }
    ...
    public void testAdvance1() throws Exception {
        ...
        assertSuccess(// --- input code ---
            "\\muskip1=2mu" + "\\advance\\muskip1 1mu" + "\\the\\muskip1\\end",
            // --- log message ---
            "3.0mu" + TERM);
    }
    ...
    public void testAdvance2() throws Exception {
        ...
        assertSuccess(// --- input code ---
            "\\muskip0=1mu" + "\\muskip1=2mu" + "\\advance\\muskip1\\muskip0 "
                    + "\\the\\muskip1\\end",
            // --- log message ---
            "3.0mu" + TERM);
    }
    ...
    public void testDivide1() throws Exception {
        ...
        assertSuccess(// --- input code ---
            "\\muskip1=2mu" + "\\divide\\muskip1 2 " + "\\the\\muskip1\\end",
            // --- log message ---
            "1.0mu" + TERM);
    }
    ...
    public void testMultiply1() throws Exception {
        ...
        assertSuccess(// --- input code ---
            "\\muskip1=2mu" + "\\multiply\\muskip1 2 " + "\\the\\muskip1\\end",
            // --- log message ---
            "4.0mu" + TERM);
    }
