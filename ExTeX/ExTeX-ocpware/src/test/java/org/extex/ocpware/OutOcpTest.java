...
public class OutOcpTest {
    ...
    public void test1() throws Exception {
        ...
        run(new String[]{}, "outocp: No file given\n", "");
    }
    ...
    public void test1de() throws Exception {
        ...
        run(new String[]{}, "outocp: Es wurde keine Datei angegeben\n", "");
    }
    ...
    public void test2() throws Exception {
        ...
        Locale.setDefault(Locale.ENGLISH);
        run(new String[]{"x", "x"}, "outocp: Too many arguments\n", "");
    }
    ...
    public void test2de() throws Exception {
        ...
        Locale.setDefault(Locale.GERMAN);
        run(new String[]{"x", "x"}, "outocp: Zu viele Argumente\n", "");
    }
    ...
    public void test3() throws Exception {
        ...
        run(new String[]{"nonexistentFile"},
            "outocp: File nonexistentFile not found\n", "");
    }
    ...
    public void test3de() throws Exception {
        ...
        Locale.setDefault(Locale.GERMAN);
        run(new String[]{"nonexistentFile"},
            "outocp: Datei nonexistentFile nicht gefunden\n", "");
    }
