...
public class XtfReaderFxlrTest {
    ...
    public void test04() {
        ...
        assertEquals(
            "LinuxLibertine by Philipp H. Poll, Free Font under Terms of the " +
                "GPL (General Public License - http://www.gnu" +
                ".org/copyleft/gpl.html) and OFL (Open Font Licence). Created" +
                " with FontForge 1.0 (http://fontforge.sf.net) Sept 2003, " +
                "2004, 2005, 2006, 2007",
            font.getNotice() );
