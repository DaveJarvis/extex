...
public class TtfTableGLYF extends AbstractXtfTable
   ...
   * if not set do not round xy values to grid (relevant only to bit 1 is
   * set)</td>
   * </tr>
   * <tr>
  ...
  public static class CompositeDescript extends Descript {
     ...
     * the components
     */
    private final Vector<CompositeComp> components =
        new Vector<CompositeComp>();
   ...
   */
  public TtfTableGLYF( XtfTableMap tablemap, XtfTableDirectory.Entry de,
