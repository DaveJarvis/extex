...
public class T2Flex extends T2PathConstruction {
     ...
     */
    public T2Flex(List<T2CharString> stack, CharString ch) throws IOException {

        super(stack, new short[]{ESCAPE_BYTE, T2FLEX}, ch);
        ...
        dy6 = (T2Number) stack.remove(0);
        fd = (T2Number) stack.remove(0);
    ...
    public void writeXML(XMLStreamWriter writer) throws IOException {
        ...
        writer.writeAttribute("dy6", dy6);
        writer.writeAttribute("fd", fd);
