...
public class FontFactoryImplAfmTest extends AbstractFontFactoryTester {
  ...
  public void test05() throws Exception {
    ...
    assertTrue( ex.toString(),
                new Dimen( Dimen.ONE * 10 * 431 / 1000 ).eq( ex ) );
  ...
  public void testKerning05() throws Exception {
    ...
    assertNotNull( k );
    assertTrue( k.toString(),
                new Dimen( Dimen.ONE * 10 * -29 / 1000 ).eq( k ) );
  ...
  public void testKerning06() throws Exception {
    ...
    assertNotNull( k );
    assertTrue( k.toString(),
                new Dimen( Dimen.ONE * 10 * -12 / 1000 ).eq( k ) );
  ...
  public void testLigature06() throws Exception {
    ...
    assertNotNull( l );
    assertEquals( param.getUnicode( "f_f_i" ).getCodePoint(),
                  l.getCodePoint() );
