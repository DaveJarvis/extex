...
public class PageManagerTest {
  ...
  /**
   * Check that only the page 1 is accepted if only this page is requested
   * (single page number)
   */
  @Test
  public void test1() {
  ...
  /**
   * Check that only the page 2 is accepted if only this page is requested
   * (single page number)
   */
  @Test
  public void test2() {
  ...
  /**
   * Check that only the pages 1 and 3 is accepted if only this page is
   * requested (comma operator)
   */
  @Test
  public void test4() {
  ...
  /**
   * Check that all the pages up to 2 are accepted if only this page is
   * requested (initial to operator)
   */
  @Test
  public void test5() {
  ...
  /**
   * Check that all the pages greater than 12 are accepted if only this page
   * is requested (terminal to operator)
   */
  @Test
  public void test6() {
