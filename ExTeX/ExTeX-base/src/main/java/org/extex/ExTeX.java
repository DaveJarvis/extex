 ...
 * <dd>This parameter contains εχTeX code to be executed directly. The
 ...
 * is defined for compatibility to TeX only. In εχTeX it has no effect at all
 * .</dd>
 *
 ...
 *
 * <p>
 * The configuration of εχTeX is controlled by several configuration
 * resources. The
 ...
 * <dt>{@link #makeOutputFactory(String, Configuration) makeOutputFactory()}
 * </dt>
 ...
 * <dl>
 * <dt>{@link #makeFontFactory(Configuration, ResourceFinder) makeFontFactory
 * ()}</dt>
 ...
 * <dl>
 * <dt>{@link #makeDefaultFont(Configuration, CoreFontFactory)
 * makeDefaultFont()}
 * </dt>
 ...
 * </dl>
 * </dd>
 * <dt>{@link #initializeStreams(Interpreter, Properties) initializeStreams
 * ()}</dt>
...
public class ExTeX {
   ...
   *                      and modified. The caller should provide a new
   *                      instance if this is
   *                      not desirable.
   ...
   * @param dotFile       the name of the local configuration file. In the
   *                      case that
  ...
  protected Interpreter makeInterpreter( Configuration config,
                                         ...
                                         ResourceFinder finder,
                                         String jobname )
      throws GeneralException, FontException, IOException {
    ...
    interpreter.setContext( makeContext( interpreterConfig,
                                         tokenFactory,
                                         fontFactory,
                                         interpreter,
                                         finder,
   ...
   *                      contain a tag {@code banner}. If present then the
   *                      value is used.
   *                      The configuration can be {@code null}. Then it is
   *                      ignored.
