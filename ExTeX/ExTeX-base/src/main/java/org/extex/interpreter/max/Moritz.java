...
public class Moritz extends Max
   ...
   * @param insert     the token to insert either at the beginning of the
   *                   box or
   *                   after the box has been gathered. If it is {@code
   *                   null} then
   *                   nothing is inserted
   ...
   *                          that the token read is not a control sequence
   *                          token
   ...
   *                          file has been reached before an integer could
   *                          be acquired
   */
  @Override
   ...
   * @throws HelpingException       in case that no number is found or the
   * end of
   *                                file has been reached before an integer
   *                                could be acquired
   * @throws MissingNumberException in case that no number is found or the end
   *                                of file has been reached before an
   ...
   * @throws org.extex.framework.configuration.exception.ConfigurationException this exception is never thrown. It is defined here to provide an
   *
