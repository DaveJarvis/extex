...
public abstract class AbstractNodeListTester {
  ...
  /**
   * Test that clearing an empty list removes all nodes and resets all
   * dimensions to 0
   */
  @Test
  ...
  /**
   * Test that clearing a list with one element removes all nodes and resets
   * all dimensions to 0
   */
  @Test
  ...
  /**
   * Test that clearing a list with two elements removes all nodes and resets
   * all dimensions to 0
   */
  @Test
  ...
  /**
   * Calling the visit() method invokes the appropriate method in the visitor
   * and the argument is passed down
   *
   * @throws GeneralException in case of an error
   */
  @Test
