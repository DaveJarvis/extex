        ...
        if( ++i >= noads.size() ) {
          ...
          if( n instanceof SimpleNoad ) {
            ...
            if( nuc instanceof CharNoad ) {
              ...
              //                  cur_c ? character(nucleus(p)); cur_i ?
              //                  font_info[a].qqqq;
              //                  if skip_byte(cur_i)>stop_flag then
              //                    begin a ? lig_kern_restart(cur_f)(cur_i);
              //                    cur_i ? font_info[a].qqqq;
              //                    end ;
              //                   loop begin ?If instruction cur_i is a kern
              //                   with cur_c, attach the kern after q; or if
              //                   it is a ligature with cur_c, combine noads
              //                   q and p appropriately; then return if the
              //                   cursor has moved past a noad, or goto
              //                   restart 753?;
              //                    if skip_byte(cur_i) ? stop_flag then
              //                    return ;
              //                    a ? a+qo(skip_byte(cur_i))+1; cur_i ?
              //                    font_info[a].qqqq;
              //                    end ;
              //                  end ;
              //                end ;
