 ...
 * {@link MathClass MathClass}es for which several types exist.
 * </p>
 * <p>
 * The original idea was to attach the desired functionality to the sub-types
 * and let it have one common method to invoke it. This turns out not to be
 * practical for modular components where the algorithm might be exchanged. Any
 * new implementation would have the need to extend the MathClass classes.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * The definition of the parameter and the return value are rather general. Thus
