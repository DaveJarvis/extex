...
/**
 * This is a test suite for the primitive {@code \pdfthreadhoffset}.
 * 
...
public class PdfthreadhoffsetTest extends AbstractDimenRegisterTester {
    ...
    public static void main(String[] args) {
        ...
        (new JUnitCore()).run(PdfthreadhoffsetTest.class);
    }


    public PdfthreadhoffsetTest() {

        super("pdfthreadhoffset", "", "0.0pt");
