...
public class OcpPrimitiveTest extends NoFlagsButGlobalPrimitiveTester {
  ...
  public OcpPrimitiveTest() {
    ...
    setPrimitive( "ocp" );
    setArguments( "\\abc=../ExTeX-Unit-omega/src/test/resources/destroy" );
  ...
  public void testGlobal1() throws Exception {
    ...
    assertFailure(// --- input code ---
                  DEFINE_BRACES
                      + "{\\ocp\\x=../ExTeX-Unit-omega/src/test/resources" +
                      "/destroy }"
                      + "\\x\\end",
                  // --- error channel ---
  ...
  public void testGlobal2() throws Exception {
    ...
    assertFailure(// --- input code ---
                  DEFINE_BRACES
                      + "{\\global\\ocp\\x=." +
                      "./ExTeX-Unit-omega/src/test/resources/destroy }"
                      + "\\x\\end",
                  // --- error channel ---
  ...
  public void test0() throws Exception {
    ...
    assertFailure(// --- input code ---
                  ...
                  // --- error channel ---
                  "OCP file ocp_which_does_not_exist_at_all not loadable: ocp" +
                      " file " +
                      "not found." );
  }
  ...
  public void test1() throws Exception {
    ...
    Interpreter interp = assertSuccess(// --- input code ---
                                       "\\ocp\\x=../ExTeX-Unit-omega/src/test" +
                                           "/resources/destroy \\end",
                                       // --- output channel ---
                                       "" );
