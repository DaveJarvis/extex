...
public class MacroCodeTest extends ExTeXLauncher {
  ...
  public void test3() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  DEFINE_CATCODES + "\\def\\abc#1x#2{-#1-#2-}" + "\\abc9x87" +
                      "\\end",
                  // --- output channel ---
                  "-9-8-7" + TERM );
  }
  ...
  public void test4() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  DEFINE_CATCODES + "\\def\\abc#1x#2{-#1-#2-}" + "\\abc98x7" +
                      "\\end",
                  // --- output channel ---
                  "-98-7-" + TERM );
  }
  ...
  public void test5() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  DEFINE_CATCODES + "\\def\\abc#1#2{-#1-#2-}" + "\\abc{98}7" +
                      "\\end",
                  // --- output channel ---
                  "-98-7-" + TERM );
  }
  ...
  public void test6() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  DEFINE_CATCODES + "\\def\\abc#1#2{-#1-#2-}" + "\\abc9{87}6" +
                      "\\end",
                  // --- output channel ---
                  "-9-87-6" + TERM );
  }
  ...
  /**
   * Test case checking that scanning for a parameter at eof leads to an 
   * exception
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test case checking that scanning for a token which does never come leads
   * to an exception
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test case checking that scanning for a token after a parameter which 
   * does never come leads to an exception
   *
   * @throws Exception in case of an error
   */
  @Test
  ...
  /**
   * Test case checking that scanning for an unclosed argument block leads to
   * an exception
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test case checking that scanning for an unopened argument block leads to
   * an exception
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test case checking that braces are removed when scanning for a following
   * token
   *
   * @throws Exception in case of an error
   */
  ...
  public void test11() throws Exception {
    ...
    assertOutput(// --- input code ---
                 DEFINE_CATCODES + "\\def\\abc#1#{\\write22 }" + "\\abc1{23" +
                     "}\\end",
                 // --- error channel ---
                 "23",
                 // --- output channel ---
  ...
  /**
   * Test case checking that a \par in a macro argument of a macro which is 
   * not long leads to an exception
   *
   * @throws Exception in case of an error
   */
  @Test
  ...
  /**
   * Test case checking that a \par in a macro argument of a macro which is 
   * long does not lead to an exception
   *
   * @throws Exception in case of an error
   */
  @Test
  public void test15() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  DEFINE_CATCODES + "\\long\\def\\abc#1.{}" + "\\abc a\\par b" +
                      ".\\end",
                  // --- output channel ---
                  "" );
  }
  ...
  /**
   * Test case checking that a macro without parameters and an empty 
   * replacement text is showable
   *
   * @throws Exception in case of an error
   */
  @Test
  ...
  /**
   * Test case checking that a macro without parameters and a non-empty 
   * replacement text is showable
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test case checking that a macro with parameter and a non-empty 
   * replacement text is showable
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test case checking that a macro with parameter and a non-empty 
   * replacement text and trailing { is showable
   *
   * @throws Exception in case of an error
   */
  @Test
  ...
  /**
   * Test case checking that a macro with parameter and a non-empty 
   * replacement text with the parameter is showable
   *
   * @throws Exception in case of an error
   */
  @Test
  ...
  /**
   * Test case checking that a macro with parameter and a non-empty 
   * replacement text with doubled # is showable
   *
   * @throws Exception in case of an error
   */
  @Test
  ...
  /**
   * Test case checking that a macro with macros in the expansion text is 
   * showable
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * Test case checking that a macro with macros in the expansion text is 
   * showable and respects \escapechar
   *
   * @throws Exception in case of an error
   */
  @Test
