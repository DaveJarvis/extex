...
public class IfxTest extends ConditionalTester {
  ...
  public void testMacro4() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  "\\let\\xx\\undefined\\ifx \\xx\\undefined true\\else " +
                      "false\\fi",
                  // --- output channel ---
                  "true" + TERM );
  }
  ...
  public void testCsname1() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  "\\expandafter\\ifx \\csname xx\\endcsname\\relax " +
                      "true\\else " +
                      "false\\fi",
                  // --- output channel ---
                  "true" + TERM );
  ...
  public void testTeXbook() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  DEFINE_BRACES + "\\def\\a{\\c}" + "\\def\\b{\\d}" + "\\def" +
                      "\\c{\\e}"
                      + "\\def\\d{\\e}" + "\\def\\e{A}"
                      + "\\ifx\\c\\d t \\else f \\fi "
                      + "\\ifx\\a\\b t \\else f \\fi "
  ...
  public void testFont4() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  "\\font\\f cmr10 " + "\\let\\g\\f " + "\\ifx\\f\\g t\\else " +
                      "f\\fi"
                      + "\\end",
                  // --- output channel ---
                  "t" + TERM );
  ...
  public void test11() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  DEFINE_BRACES + "\\def\\x{a}" + "\\ifx a\\x true\\else " +
                      "false\\fi",
                  // --- output channel ---
                  "false" + TERM );
  }
