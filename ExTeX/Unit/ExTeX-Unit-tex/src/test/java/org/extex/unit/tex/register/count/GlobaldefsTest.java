...
public class GlobaldefsTest extends ExTeXLauncher {
  ...
  /**
   * Test case showing that an assignment of a constant 123 works when 
  ...
  /**
   * Test case showing that an advancement by the constant -123 works when 
  ...
  public void testCountRegisterMultiply5() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  "\\globaldefs=1 " + "\\" + invocation + "=12 "
                      + "\\begingroup\\multiply\\" + invocation + " 3 " +
                      "\\endgroup"
                      + "\\the\\" + invocation + "\\end",
                  // --- output channel ---
                  "36" + TERM );
  ...
  public void testCountRegisterAfterassignment4() throws Exception {
    ...
    assertSuccess(// --- input code ---
                  "\\afterassignment b a" + "\\divide\\" + invocation + "-123" +
                      " c\\end",
                  // --- output channel ---
                  "abc" + TERM );
  }
