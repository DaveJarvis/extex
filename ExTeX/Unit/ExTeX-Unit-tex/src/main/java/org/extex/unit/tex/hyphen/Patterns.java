...
public class Patterns extends AbstractHyphenationCode {
  ...
  private class TV implements TokenVisitor<Boolean, Object> {
    ...
    /**
     * This visit method is invoked on an active token. In TeX this is e
     * .g. ~.
     *
    ...
    /**
     * This visit method is invoked on an escape token. In TeX this
     * normally means a control sequence.
     *
