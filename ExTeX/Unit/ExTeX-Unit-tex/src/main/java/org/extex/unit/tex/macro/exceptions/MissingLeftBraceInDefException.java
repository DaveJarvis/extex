...
*/
public class MissingLeftBraceInDefException extends HelpingException {
     ...
     */
    public MissingLeftBraceInDefException(String primitive) {

        super(LocalizerFactory.getLocalizer(MissingLeftBraceInDefException.class),
            "TTP.MissingLeftBraceInDef", primitive);
    }
