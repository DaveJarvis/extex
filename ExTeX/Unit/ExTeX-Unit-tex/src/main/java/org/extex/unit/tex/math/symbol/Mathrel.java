...
/**
 * This class provides an implementation for the primitive {@code \mathrel}.
 * 
 * <p>The Math Primitive {@code \mathrel}</p>
 * <p>
 * The primitive {@code \mathrel} takes an argument and treats it as a
 ...
 * <pre class="syntax">
 *    &lang;mathrel&rang;
 *       &rarr; {@code \mathrel} &lang;formula&rang;
 *
 *    &lang;formula&rang;
