 ...
 */
public class OuterInDefException extends HelpingException {
   ...
   */
  public OuterInDefException( String primitive ) {

    super( LocalizerFactory.getLocalizer( OuterInDefException.class ),
           "TTP.OuterInDef", primitive );
  }
