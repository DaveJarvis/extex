 ...
 * {@code \muskipdef}.
 * 
 * <p>The Primitive {@code \muskipdef}</p>
 * <p>
 * The primitive {@code \muskipdef} can be used to define a control sequence as
 * alias for a muskip register. The control sequence can be used wherever a
 * muskip register is expected afterwards.
 * </p>
 * <p>
 * The primitive {@code \muskipdef} is an assignment. Thus the settings of
 ...
 * <pre class="syntax">
 *    &lang;muskipdef&rang;
 *      &rarr; &lang;modifier&rang; {@code \muskipdef} {@linkplain
