...
public interface GroupExtension extends Group, Tokenizer, Serializable {
    ...
    /**
     * Getter for the named transform register in the current group. The name
     * can either be a string representing a number or an arbitrary string. In
    ...
    /**
     * Getter for the named hash-toks register in the current group. The name
     * can either be a string representing a number or an arbitrary string. In
