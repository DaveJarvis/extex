...
public class TokenStreamBaseImplTest {
  ...
  /**
   * This test case validates that closeFileStream() succeeds on an empty
   * file stream
   */
  @Test
  ...
  /**
   * This test case validates that closeFileStream() fails on an empty
   * non-file stream
   */
  @Test
  ...
  /**
   * This test case validates that closeFileStream() discards any remaining
   * characters
   *
  ...
  /**
   * This test case validates that get() returns {@code null} on en empty
   * stream
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * This test case validates that getLocator() returns an locator pointing
   * initially to the line 0
   */
  @Test
  ...
  /**
   * This test case validates that an empty stream reports isEof() as {@code
   * true}
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * This test case validates that an empty stream reports isEol() as {@code
   * true}
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * This test case validates that the boolean constructor flag indicates a
   * file stream (positive case)
   */
  @Test
  ...
  /**
   * This test case validates that put() puts a single token back into the
   * stream
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * This test case validates that put() puts several tokens back into the
   * stream
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * This test case validates that skipSpaces() forces the deletion of a
   * space token
   *
   * @throws Exception in case of an error
   */
  ...
  /**
   * This test case validates that skipSpaces() forces the deletion of
   * multiple space token
   *
   * @throws Exception in case of an error
   */
  @Test
  ...
  /**
   * This test case validates that the constructor injects a token list with
   * one element
   *
   * @throws Exception in case of an error
   */
