 ...
 * codes. This interface is used to implement the visitor pattern.
 *
...
public interface CatcodeVisitor<RET, ARG1, ARG2, ARG3> {
  ...
  /**
   * This visit method is invoked on a comment token. In TeX this normally
   * is a %.
   *
   * @param arg1 the first argument to pass
   * @param arg2 the second argument to pass
   ...
   * @throws Exception in case of an error
   */
  RET visitLeftBrace( ARG1 arg1, ARG2 arg2, ARG3 arg3 ) throws Exception;
   ...
   * @throws Exception in case of an error
   */
  RET visitMathShift( ARG1 arg1, ARG2 arg2, ARG3 arg3 ) throws Exception;
   ...
   * @throws Exception in case of an error
   */
  RET visitRightBrace( ARG1 arg1, ARG2 arg2, ARG3 arg3 ) throws Exception;
