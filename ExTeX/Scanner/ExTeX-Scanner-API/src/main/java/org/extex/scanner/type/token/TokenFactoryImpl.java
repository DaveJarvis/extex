...
public class TokenFactoryImpl
   ...
   * tokens.
   */
  private final Map<String, Map<UnicodeChar,
      WeakReference<ActiveCharacterToken>>> activeCache =
      new HashMap<String, Map<UnicodeChar,
          WeakReference<ActiveCharacterToken>>>();
   ...
   */
  @Override
  public Token visitComment( String value, UnicodeChar uchar,
                             String namespace ) {
   ...
   */
  @Override
  public Token visitIgnore( String value, UnicodeChar uchar,
                            String namespace ) {
   ...
   */
  @Override
  public Token visitInvalid( String value, UnicodeChar uchar,
                             String namespace ) {
