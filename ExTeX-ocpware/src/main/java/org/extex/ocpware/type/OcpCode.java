...
public enum OcpCode {
     ...
     */
    GOTO_NO_ADVANCE(33, "GOTO_NO_ADVANCE", "l"),
     ...
     */
    OcpCode(int opcode, String instruction, String arguments) {
