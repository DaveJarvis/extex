...
public class IndexerTest {
   ...
   * @throws IOException in case of an error
   */
  protected void run( String in, String style, String out, String log,
                      int exit )
      throws IOException {
  ...
  public final void testPages10() throws IOException {
    ...
    run(
        ...
        "\\begin{theindex}\n"
            + "\n"
            + "  \\item \\textsf  {alpha.bst}, \\hyperpage{57--60}, " +
            "\\hyperpage{62--72}, \n"
            + "\t\t\\hyperpage{74--76}\n" + "\n" + "\\end{theindex}\n",
        "", 0 );
  }
  ...
  public final void testPages3() throws IOException {
    ...
    run(
        "\\indexentry{bst|hyperpage}{1}\n"
            + "\\indexentry{bst|hyperpage}{1}\n",
        MARKER_STYLE,
        "<preamble><item_0>bst<delim_0><encap_prefix>hyperpage<encap_infix>1" +
            "<encap_suffix><postamble>",
        "",
        0 );
  }
  ...
  public final void testPages4() throws IOException {
    ...
    run(
        "\\indexentry{bst|tt}{1}\n"
            + "\\indexentry{bst|tt}{2}\n",
        MARKER_STYLE,
        "<preamble><item_0>bst<delim_0><encap_prefix>tt<encap_infix>1<delim_n" +
            ">2<encap_suffix><postamble>",
        "",
        0 );
  }
  ...
  public final void testSubitem1() throws IOException {
    ...
    run(
        ...
        MARKER_STYLE,
        "<preamble><item_0>bst<item_x1>plain<delim_1><encap_prefix>hyperpage" +
            "<encap_infix>43<delim_r>44<encap_suffix><postamble>",
        "",
        0 );
  }
