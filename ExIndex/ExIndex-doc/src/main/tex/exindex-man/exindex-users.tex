...
%\maketitle
  ...
  \begin{abstract}\parindent=0pt
    This document describes \ExIndex. It explains how to get \ExIndex\ up
    and running and which features \ExIndex\ offers to you.

    The intended audience for this document are end users of a
    index processor who want to use \ExIndx\ on the command line or
    as plug-in replacement of makeindex or xindy.
  \end{abstract}
  \unitlength=1mm
  \begin{picture}(0,0)
...
\newpage
\footnotesize
\copyright\ 2007 The \ExTeX\ Group and individual authors listed below 
\medskip
