  ...
  public final void test1() throws Exception {
    ...
    try( final Writer w = new FileWriter( idx ) ) {
      w.write( "\\indexentry{Java|)hyperpage}{11}\n"
                   ...
                   + "\\indexentry{ls-R@\\textsf  " +
                   "{ls-R}|hyperpage}{11}\n"
                   + "\\indexentry{TEXMF|)hyperpage}{11}\n"
                   + "\\indexentry{installer|hyperpage}{12}\n"
                   + "\\indexentry{ExBib-setup.jar@\\textsf  " +
                   "{ExBib-setup.jar}|hyperpage}{12}\n"
                   + "\\indexentry{ExBib-setup.jar@\\textsf  " +
                   "{ExBib-setup.jar}|hyperpage}{12}\n"
                   + "\\indexentry{installer|hyperpage}{12}\n"
                   ...
                   "directory|hyperpage}{13}\n"
                   + "\\indexentry{directory " +
                   "installation|hyperpage}{13}\n"
                   ...
                   + "\\indexentry{installation directory|" +
                   "(hyperpage}{15}\n"
                   + "\\indexentry{directory installation|" +
                   "(hyperpage}{15}\n"
                   + "\\indexentry{Uninstaller@\\textsf  " +
                   "{Uninstaller}|hyperpage}{16}\n"
                   + "\\indexentry{bin@\\textsf  " +
                   "{bin}|hyperpage}{16}\n"
                   + "\\indexentry{doc@\\textsf  " +
                   "{doc}|hyperpage}{16}\n"
                   + "\\indexentry{lib@\\textsf  " +
                   "{lib}|hyperpage}{16}\n"
                   + "\\indexentry{directory installation|)" +
                   "hyperpage}{16}\n"
                   + "\\indexentry{installation directory|)" +
