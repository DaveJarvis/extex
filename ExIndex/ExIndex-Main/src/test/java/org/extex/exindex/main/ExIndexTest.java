...
public class ExIndexTest {
  ...
  public final void testFilter2() throws Exception {
    ...
    runTest(
        ...
        "Starting the processing phase.\n"
            + "Reading <stdin>.\n"
            + "The class java.lang.String for filter test0 does not " +
            "extend Reader. This is\n"
  ...
  public final void testFilter3() throws Exception {
    ...
    runTest(
        ...
        "Starting the processing phase.\n"
            + "Reading <stdin>.\n"
            + "No filter class found in properties.This is most probable a " +
            "programming or\n"
            + "configuration error.\n" );
  }
  ...
  public final void testFilter4() throws Exception {
    ...
    runTest(
        ...
        "Starting the processing phase.\n"
            + "Reading <stdin>.\n"
            + "The class org.extex.UnDeF for filter test2 could not " +
            "be found. This is most\n"
  ...
  public final void testFilter5() throws Exception {
    ...
    runTest(
        ...
        "Starting the processing phase.\n"
            + "Reading <stdin>.\n"
            + "The filter class java.io.Reader for filter test3 does not have" +
            " a proper\n"
            + "constructor. This is most probable a programming or " +
            "configuration error.\n" );
  }
  ...
  public final void testFilter6() throws Exception {
    ...
    runTest(
        ...
        "Starting the processing phase.\n"
            + "Reading <stdin>.\n"
            + "The filter class java.io.StringReader for filter test4 does " +
            "not have a proper\n"
            + "constructor. This is most probable a programming or " +
            "configuration error.\n" );
  }
  ...
  public final void testFilter7() throws Exception {
    ...
    runTest(
        ...
        "Starting the processing phase.\n"
            + "Reading <stdin>.\n"
            + "Filter error for filter testBad1: java.lang" +
  ...
  public final void testStyle3() throws Exception {
    ...
    runTest( new String[]{"-trans", "xxx", "-s",
             ...
             "Scanning style file ../ExIndex-Main/src/test/resources/makeidx." +
                 "." +
                 ".done (?\n"
  ...
  public final void testStyle4() throws Exception {
    ...
    runTest(
        ...
        0,
        "Scanning style file ../ExIndex-Main/src/test/resources/doc.." +
            ".done (7 attributes\n"
            + "redefined, 0 ignored).\n"
            + "Starting the processing phase.\n"
            + "Reading <stdin>.\n"
