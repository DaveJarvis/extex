 ...
 *
 * <div style="float:right;"> <img src="doc-files/classes.png" alt="classes">
 *   <br>
...
public class StructuredIndex extends LetterGroupContainer
   ...
   *
   * @param name     the name of the index; "" for the default; this value
   *                 is not
   *                 {@code null}
    ...
    if( group == null ) {
      ...
      if( group == null ) {
        throw new IndexerException( null, LocalizerFactory.getLocalizer(
            getClass() ).format( "NoProperLetterGroup",
                                 entry.toString() ) );
      }
    }
