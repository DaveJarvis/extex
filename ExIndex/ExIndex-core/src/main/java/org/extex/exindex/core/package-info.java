 ...
 *    index style. The structured index might be used bay the document preparation
 ...
 *    and intermediate results. Our view leaves it open where those data structures
 *    reside. In the classical scenario of TeX the intermediate data structures are
