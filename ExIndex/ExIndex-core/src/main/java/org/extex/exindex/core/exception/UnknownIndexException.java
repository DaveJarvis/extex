 ...
 */
public class UnknownIndexException extends IndexerException {
     ...
     */
    public UnknownIndexException(ResourceLocator locator, String message) {

        super(locator, LocalizerFactory.getLocalizer(
            UnknownIndexException.class).format("Message", message));
    }
}
