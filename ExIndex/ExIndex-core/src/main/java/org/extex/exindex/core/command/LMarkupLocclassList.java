 ...
 * 
*
 * <p>The Command {@code markup-locclass-list}</p>
 * 
 * <p>
 * The command {@code markup-locclass-list} can be used to specify the markup
 ...
 * key of the function name (i.e. {@code markup-locclass-list}).
 * </p>
 * 
 * 
 * @author <a href="mailto:gene@gerd-neugebauer.de">Gerd Neugebauer</a>
*/
public class LMarkupLocclassList extends AbstractLAdapter {
     ...
     */
    public LMarkupLocclassList(String name, IndexContainer container)
