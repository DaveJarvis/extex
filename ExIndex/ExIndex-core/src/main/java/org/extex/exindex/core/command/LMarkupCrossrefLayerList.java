 ...
 * 
 * <doc command="markup-crossref-layer-list">
...
public class LMarkupCrossrefLayerList extends AbstractLAdapter {
     ...
     */
    public LMarkupCrossrefLayerList(String name, IndexContainer container)
    ...
    /**
     * Take the markup for a cross reference layer list and store it.
     * 
