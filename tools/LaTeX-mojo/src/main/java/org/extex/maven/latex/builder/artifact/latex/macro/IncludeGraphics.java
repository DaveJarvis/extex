...
/**
 * This class implements a handler for <code>\includegraphics</code>.
 * 
 * @author <a href="mailto:gene@gerd-neugebauer.de">Gerd Neugebauer</a>
 * @version $Revision$
 */
public final class IncludeGraphics extends MacroWithArgs {
    ...
    public void expand(LatexReader reader, DependencyNet net,
        ...
        File file =
                net.findFile(arg, net.getParameters().getGraphicsExtensions(),
                    artifact);
