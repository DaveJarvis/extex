...
public class ArtifactDependency implements Dependency {
    ...
    /**
     * The field <tt>targetArtifact</tt> contains the ...
     */
     ...
     */
    public ArtifactDependency(Artifact targetArtifact) {
    ...
    public boolean isUpToDate(Artifact source, Map<String, String> context) {
        ...
        // TODO gene: isUpToDate unimplemented
        return false;
    }
    ...
    public void print(PrintWriter w, String prefix, String pre) {
        ...
        w.print(prefix);
        w.print(pre);
        w.println(targetArtifact.getFile().toString());
    }
