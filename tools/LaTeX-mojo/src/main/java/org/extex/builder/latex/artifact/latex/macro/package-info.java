 ...
 * >e</span>X macro handlers. These are invoked when control sequences or active
 * characters are encountered. The goal is not to typeset the document but to
 * record the dependencies from one source file to other constituents of the
 * final document.
 */
