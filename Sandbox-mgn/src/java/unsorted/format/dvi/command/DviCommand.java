...
package unsorted.format.dvi.command;
...
import unsorted.format.dvi.exception.DviPostNotFoundException;
import unsorted.format.dvi.exception.DviPreNotFoundException;
import unsorted.format.dvi.exception.DviUndefinedOpcodeException;
...
public abstract class DviCommand {
    ...
    private static final DviReadCommand SETCHAR = new DviReadCommand() {
         ...
         * 
         * @see unsorted.format.dvi.command.DviReadCommand#read(
         *      org.extex.util.file.random.RandomAccessR, int, int)
         */
        public DviCommand read(RandomAccessR rar, int opcode, int sp)
                throws IOException,
                    DviException,
                    FontException,
    ...
    private static final DviReadCommand[] OPCODEARRAY = {//
            ...
            /**
             * fnt_num_0 171: Set <code>f = 0</code>. BaseFont 0 must
             * previously have been defined by a <code>fnt_def</code>
             * instruction.
             */
            new DviReadCommand() {
     ...
     * @throws ConfigurationException from the config system.
     */
    public static List<DviFntDef> getFntDefs(RandomAccessR rar)
            throws IOException,
                DviException,
                FontException,
                ConfigurationException {
