...
public class OmathcodeTest extends NoFlagsButGlobalPrimitiveTester {
    ...
    /**
     * <testcase primitive="\omathcode"> Test case checking that
     * <tt>\omathcode</tt> sets the code in the Context for ordinary
     * characters correctly. </testcase>
     * 
     * @throws Exception in case of an error
     */
    ...
    /**
     * <testcase primitive="\omathcode"> Test case checking that
     * <tt>\omathcode</tt> sets the code in the Context for an opening
     * character correctly. </testcase>
     * 
     * @throws Exception in case of an error
     */
    ...
    /**
     * <testcase primitive="\omathcode"> Test case checking that
     * <tt>\omathcode</tt> sets the code in the Context for an closing
     * character correctly. </testcase>
     * 
     * @throws Exception in case of an error
     */
    ...
    /**
     * <testcase primitive="\omathcode"> Test case checking that
     * <tt>\omathcode</tt> sets the code in the Context for a variable
     * character correctly. </testcase>
     * 
     * @throws Exception in case of an error
     */
    ...
    /**
     * <testcase primitive="\omathcode"> Test case checking that
     * <tt>\omathcode</tt> can be used to define active characters.
     * </testcase>
     * 
     * @throws Exception in case of an error
     */
