...
if (parent.frames.length == 0) {
  ...
  document.writeln('   <frame src="docs.html" name="unitFrame" title="All primitives">');
  ...
  document.writeln('  This document is designed to be viewed using the frames feature.');
  document.writeln('  If you see this message, you are using a non-frame-capable web client.');
  document.writeln(' </noframes>');
  document.writeln('</frameset>');
  document.writeln('</html>');
  document.close();
