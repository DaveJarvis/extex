...
public class XMLDoclet1 extends Doclet {
    ...
    public static boolean start(final RootDoc root) {
        ...
        //erstellen von verweisen f�r packagename.xml (Entities)
    ...
    static void printMembers(final Element parent, final ClassDoc cd,
        ...
        for (int i = 0; itr.hasNext(); ++i) {
            ...
            // methoden-parameter wegen Deklarration N�tig
            ...
            if (cmnt != null && !cmnt.equals("")) {
                ...
                //References m�ssen von XML Auswertung verkn�pft werden!
                ...
                switch (c) {
                    case '<' :
                        ...
                        if (str.length() > i + 3
                            ...
                            ret.append("</par>");
                            i += 3;
                            //TODO Aufz�hlungen, alle auf selben Typ
                        } else if (str.length() > i + 3
                                && str.substring(i, i + 4).equalsIgnoreCase(
                                        "<ol>")) {
