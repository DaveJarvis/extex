...
\renewcommand\Macro[1]{\texttt{\char`\\ #1}}
\newcommand\tag[1]{%
...
\def\setVersion$#1: #2 ${\gdef\Version{0.0 (Revision #2)}}
\setVersion$Revision$
...
\newenvironment{doc}[3]{\hypertarget{#1:#2}{}\index{#2@\texttt{\char`\\ #2}}}

\newenvironment{primitives}{\begin{quotation}\noindent\small\rightskip=0pt
  plus 20em }{\end{quotation}}

\def\ConfigUnit#1{\hyperlink{#1}{\texttt{#1}} }
\newenvironment{configurations}{}{}
\newenvironment{configuration}[2]{\let\unit\ConfigUnit 
  \subsection{The Configuration \texttt{#1}}
  The configuration \texttt{#1} loads the following units:\par
}{
}

\def\UnitDefine#1#2{ \hyperlink{#2:#1}{\Macro{#1}} }
\newenvironment{units}{}{}
\newenvironment{unit}[1]{\let\define\UnitDefine
  \hypertarget{unit/#1}{\subsection{The Unit \texttt{#1}}}
  The unit \texttt{#1} defines the following primitives:\bgroup
  \par\raggedright
}{
  \par\egroup
}
...
You need to have Java 1.5\index{Java} or later installed on your
...
\begin{lstlisting}{}
# svn checkout https://svn.berlios.de/svnroot/repos/extex/trunk
\end{lstlisting}
...
\begin{figure}[tp]
  \centering
  \includegraphics[width=.8\textwidth]{image/inst1}
...
\InputIfFileExists{generated-sources/tex/configurations.tex}{}
...
\InputIfFileExists{generated-sources/tex/units.tex}{}
...
\InputIfFileExists{generated-sources/tex/syntax.tex}{}

\section{Primitives of \ExTeX}

\ExTeX\ defines a lot of primitives. Those primitives are described below.

\InputIfFileExists{generated-sources/tex/primitives.tex}{}
