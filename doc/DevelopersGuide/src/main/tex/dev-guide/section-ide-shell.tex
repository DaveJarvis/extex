...
Berlios\index{Berlios} and be registered as committer\index{comitter}.
...
You need to download\index{download} the sources of \ExTeX. On the
command line this can be done with the following
check-out\index{check-out} commands:
...
\subsection{Maven}\label{sec:Maven}\index{Maven|(}
