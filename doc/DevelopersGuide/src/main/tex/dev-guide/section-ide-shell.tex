...
\Dir*{target}\Dir{classes}. Thus if this directory and the jars in
...
libraries found in the directory \Dir{lib}. In addition the
directory \Dir*{target}\Dir{classes} have to be on the class path.
