...
\index{Galileo|see{Eclipse $\rightarrow$ Galileo}}%
\index{Ganymede|see{Eclipse $\rightarrow$ Ganymede}}%
...
Now you can close the project in Eclipse. We will reopen the
sub-projects later on.

\subsubsection{Creating Eclipse Projects}

Eclipse uses some control files to define an Ecipse project. Usually
these files can be generated automatically by Maven. Thus they should
not be checked into the repository. They are included in the
\+svn:ignore+ list.
