...
dialog to be not be asked again.
...
A dictionary\index{dictionary} can be downloaded from SCOWL\index{SCOWL}
...
\begin{description}
\item [Update site:] \url{http://download.eclipse.org/releases/helios}
...
\begin{description}
\item [Update site:] \url{http://community.polarion.com/projects/subversive/download/eclipse/2.0/update-site/}
\item [Component:] \menu{Subversive SVN Connectors}
\end{description}
...
Another recompilation can be triggered via the Maven task
\texttt{compile}: 
