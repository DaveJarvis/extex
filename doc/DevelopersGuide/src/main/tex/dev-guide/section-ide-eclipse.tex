...
figure~\ref{fig:eclipse-svn-1}). You see a lot of windows and icons
there. The tab ``SVN Repositories'' on the left side shows all
repository locations currently known. This list is empty since we have
not added any SVN location yet.
\begin{figure}[htbp]
  \centering  \includegraphics[scale=.33]{image/eclipse-svn-1}
  \caption{CVS Exploring Perspective}\label{fig:eclipse-svn-1}
\end{figure}
