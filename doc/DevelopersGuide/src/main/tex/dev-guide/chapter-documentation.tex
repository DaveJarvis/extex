...
literate programming\index{literate programming}. The source code and
documentation are extracted from a common file. In the Java world the
Javadoc\index{Javadoc} system has been invented for a similar purpose.
...
Javadoc\index{Javadoc} comments of the implementing Java classes. A
