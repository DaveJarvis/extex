%%*****************************************************************************
\SVN$Id: chapter-licenses.tex 7892 2009-08-07 14:37:56Z gene $
%%*****************************************************************************
%%
...
LGPL\index{LGPL}. But in order to keep open linking facility against all the
...
\begin{itemize}
\item LGPL\index{LGPL}\\
  for obvious reasons.
\item  modified BSD licence\index{BSD license}
  (\url{http://www.xfree86.org/3.3.6/COPYRIGHT2.html#5})\\
  We can always convert this licence to LGPL.
\item  Apache 2.0 licence \\\index{Apache 2.0 licence}
  Unfortunately linking with GPL2 programs is in gray area.
  Interpretation differs between FSF and Apache but GPLv3 will be
  compatible.
\item Public domain\\\index{Public domain}
  (obvious)
\item GPL\index{GPL} with explicit linking clause that don't enforce
...
\begin{itemize}
\item GPL license:\\\index{GPL}
  We would loose the free linking facility.
\item Apache 1.1 license:\\\index{Apache 1.1 licence}
  It forbids linking with GPL software. Check if an upgrade to
  Apache~2.0 exists.
\item Eclipse public license:\\\index{Eclipse public license}
...
\item Original BSD license and Apache 1.0\\\index{Apache 1.0 licence}
