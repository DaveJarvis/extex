...
public class Factory<TYPE>
     ...
     */
    protected TYPE createInstance(Class<?> target)
            throws ConfigurationException {
     ...
     * @throws ConfigurationException in case of an configuration error
     */
    protected TYPE createInstance(String type, Class<?> target)
            throws ConfigurationException {
     ...
     * @throws ConfigurationException in case of an configuration error
     */
    protected TYPE createInstanceForConfiguration(Configuration config,
                ...
                switch (args.length) {
                    case 1:
                        if (args[0].isAssignableFrom(argClass)) {
                            instance = (TYPE) constructors[i].newInstance(//
                                new Object[]{arg});
    ...
    private TYPE createInstanceForConfiguration1(Configuration config,
            ...
            Constructor<TYPE> constructor, Class<?> arg0)
            throws InstantiationException,
                IllegalAccessException,
