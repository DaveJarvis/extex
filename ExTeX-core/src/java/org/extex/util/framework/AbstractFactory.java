...
package org.extex.util.framework;
...
import org.extex.util.framework.configuration.exception.ConfigurationInvalidClassException;
import org.extex.util.framework.configuration.exception.ConfigurationInvalidConstructorException;
 ...
 * </li>
 * <li>If the instantiated class implements the interface
 *   {@link org.extex.util.framework.logger.LogEnabled LogEnabled}
 *   then the associated method is used to pass on the logger to the new
 *   instance.
 * </li>
 * <li>If the instantiated class implements the interface
 *   {@link org.extex.util.framework.i18n.Localizable Localizable}
 *   then the associated method is used to pass on the localizer to the new
 *   instance. The localizer is acquired from the
 *   {@link org.extex.util.framework.i18n.LocalizerFactory LocalizerFactory}
