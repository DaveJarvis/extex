...
public interface ExtexFont extends BaseFont {
     ...
     *
     * If the character is not defined or an invalid value is given,
     * then the depth 0pt is returned.
     *
     ...
     *
     * If the character is not defined or an invalid value is given,
     * then the height 0pt is returned.
     *
     * @param uc     The Unicode char.
     ...
     *
     * If the character is not defined or an invalid value is given,
     * then the italic correction 0pt is returned.
     *
     * @param uc     The Unicode char.
     ...
     *
     * If the character is not defined or an invalid value is given,
     * then the width 0pt is returned.
     *
     * @param uc     The Unicode char.
