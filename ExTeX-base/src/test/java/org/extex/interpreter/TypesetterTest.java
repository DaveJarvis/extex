    ...
    public void test1() throws Exception {
        ...
        assertSuccess(
            ...
            "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam "
                    ...
                    + "commodo consequat. Duis autem vel eum iriure dolor in hen"
                    + "drerit in vulputate velit esse molestie consequat, vel illum dolore eu\n" //
                    + "feugiat nulla facilisis at vero eros et accumsan et iusto"
                    + " odio dignissim qui blandit praesent luptatum zzril delenit augue duis\n" //
                    + "dolore te feugait nulla facilisi. Nam liber tempor cum so"
                    + "luta nobis eleifend option congue nihil imperdiet doming id quod mazim\n" //
                    + "placerat facer possim assum. Typi non habent claritatem i"
                    + "nsitam; est usus legentis in iis qui facit eorum claritatem.\n" //
                    + "Investigationes demonstraverunt lectores legere me lius q"
                    + "uod ii legunt saepius. Claritas est etiam processus dynamicus, qui\n" //
                    + "sequitur mutationem consuetudium lectorum. Mirum est nota"
                    + "re quam littera gothica, quam nunc putamus parum claram, anteposuerit\n" //
                    + "litterarum formas humanitatis per seacula quarta decima e"
                    + "t quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari,\n" //
